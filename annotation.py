...
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
UNETdevkit_path      = 'UNETdevkit'

if __name__ == "__main__":
    random.seed(0)
    print("Generate txt in ImageSets.")
    segfilepath     = os.path.join(UNETdevkit_path, 'isic2016/train/masks')
    saveBasePath    = os.path.join(UNETdevkit_path, 'isic2016/train/imagesets/segmentation')
